...
enum layers {
    _BASE = 0,
    _NUMPAD,      // Layer 1: Numpad / calculator
    _NAVIGATION,  // Layer 2: Navigation and arrows
    _EMACS,       // Layer 4: Emacs-like cursor/editing (Windows via TAB_BELOW)
    _MODIFIER     // Layer 5: Modifier layer for EISU hold
};

// Built-in Layer-Tap for Kana: tap = KC_LNG1, hold = _NUMPAD
#define KANA_L1 LT(_NUMPAD, KC_LNG1)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_BASE] = LAYOUT(
        ...
        KC_TAB,  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_TILD, KC_BSLS, KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_MINS,
        TAB_BELOW, KC_A,  KC_S,    KC_D,    KC_F,    KC_G,    KC_BTN4, KC_LBRC, KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT,
        KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_BTN5, KC_RBRC, KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_ESC,
                                   KC_LALT, EISU_LT, KC_SPC,  KC_LGUI, MO(_NAVIGATION),  KC_SPC,  KANA_L1, KC_ENT
    ),

    [_NUMPAD] = LAYOUT(
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
        _______, _______, _______, _______, _______, _______, _______, _______, KC_LPRN, KC_7,    KC_8,    KC_9,    KC_ASTR, KC_SLSH,
        _______, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5  , KC_F6  , _______, KC_RPRN, KC_4,    KC_5,    KC_6,    KC_PLUS, KC_MINS,
        _______, KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  _______, KC_0,    KC_1,    KC_2,    KC_3,    KC_EQL,  _______,
