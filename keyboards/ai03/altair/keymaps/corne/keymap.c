...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_BASE] = LAYOUT(
        ...
        KC_TAB,  Q_ESC,   KC_W,    KC_E,    KC_R,    KC_T,    KC_BSPC, US_LBRC, KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    US_MINS,
        TAB_BELOW, KC_A,  KC_S,    KC_D,    KC_F,    KC_G,    KC_DEL,  US_RBRC, KC_H,    KC_J,    KC_K,    KC_L,    US_SCLN, US_QUOT,
        KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    _______, _______, KC_N,    KC_M,    US_COMM, US_DOT,  US_SLSH, KC_ENT,
                                   _______, KC_LALT, EISU_LT, KC_LGUI, FUNC,    KANA_L1, NAV,     _______
    ),
    ...
    [_NUMBER] = LAYOUT(
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
        US_TILD, US_EXLM, US_AT,   US_HASH, US_DLR,  US_PERC, _______, _______, US_CIRC, US_AMPR, US_ASTR, US_LPRN, US_RPRN, US_PLUS,
        US_GRV,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    _______, _______, KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    US_EQL,
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, US_BSLS, US_PIPE,
                                   _______, _______, _______, _______, _______, _______, _______, _______
    ),
